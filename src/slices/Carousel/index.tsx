 ...
 * Props for `Carouse`.
 */
export type CarouseProps = SliceComponentProps<Content.CarouseSlice>;

/**
 * Component for "Carouse" Slices.
 */
const Carousel: FC<CarouseProps> = ({ slice }) => {
